    ...
    private T GetValue()
    {
      ...
      try
      {
        ...
        else if (value is string)
        {
          ...
          {
            rValue = Convert.TryParseTo((string) value, _default);
          }
          else if (typeof(T) == typeof(float))
          {
            rValue = Convert.TryParseTo((string) value, _default, CultureInfo.InvariantCulture, NumberStyles.Number);
          }
          ...
          {
            rValue = Convert.TryParseTo((string) value, _default, CultureInfo.InvariantCulture, DateTimeStyles.None);
          }
