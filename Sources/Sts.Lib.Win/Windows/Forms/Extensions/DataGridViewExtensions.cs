...
{
    public static T GetCellValueOrDefault<T>(this System.Windows.Forms.DataGridView dataGridView, int row, int col,
                                             T def)
    {
        return GetCellValueOrDefault(dataGridView.Rows, row, col, def);
    }

    public static T GetSelectedCellValueOrDefault<T>(this System.Windows.Forms.DataGridView dataGridView, int row,
                                                     int col, T def)
    {
    ...
    private static T GetCellValueOrDefault<T>(ICollection collection, int row, int col, T def)
    {
