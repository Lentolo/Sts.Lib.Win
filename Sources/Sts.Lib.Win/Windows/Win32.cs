...
internal static class Win32
{
    ...
    internal static extern bool CreateProcessWithLogonW(string userName, string domain, string password,
                                                        uint logonFlags, string applicationName, string commandLine, uint creationFlags, uint environment,
                                                        string currentDirectory, ref Structs.StartupInfo startupInfo,
                                                        out Structs.ProcessInformation processInformation);
    ...
    internal static extern bool LogonUser([MarshalAs(UnmanagedType.LPStr)] string pszUserName,
                                          [MarshalAs(UnmanagedType.LPStr)] string pszDomain, [MarshalAs(UnmanagedType.LPStr)] string pszPassword,
    ...
    internal static extern bool DuplicateToken(IntPtr existingTokenHandle, int securityImpersonationLevel,
    ...
    internal static extern int SHGetFolderLocation(IntPtr hwndOwner, int nFolder, IntPtr hToken, uint dwReserved,
                                                   out IntPtr ppidl);

    [DllImport("Shell32.dll")]
    internal static extern IntPtr SHGetFileInfo(IntPtr pszPath, uint dwFileAttributes, ref Structs.SHFILEINFO psfi,
    ...
    [DllImport("user32.dll", SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    internal static extern bool SystemParametersInfo(Enums.SPI uiAction, uint uiParam, IntPtr pvParam,
                                                     Enums.SPIF fWinIni);
